...
export class DashboardComponent implements OnInit {
  ...
  noOfEducatedcount: any;
  noOfPregnantAndLactating: any;
  noOfWomenEducated: any;
  noOfMenEducated: any;
  ...
  constructor(private reportsService: ReportsService) {
    ...
    this.hours = 0;
    this.minutes = 0;
    this.noOfEducatedcount = 0;
    this.noOfWomenEducated = 0;
    this.noOfMenEducated = 0;
    this.noOfPregnantAndLactating = 0;
  }
  ...
  getDashboardData() {
    console.log('retreiving .reportsService.getDashboardData()');
    this.reportsService.getDashboardData().subscribe(
      data => {
        console.log(data);
        this.noOfEducatedcount = data['noOfEducatedcount'];
        this.noOfPregnantAndLactating = data['noOfPregnantAndLactating'];
        this.noOfWomenEducated = data['noOfWomenEducated'];
        this.noOfMenEducated = data['noOfMenEducated'];


      },
      err => {
        // console.error(err);
        console.error('Error received in getDashboardData.  Probably server not running')
      },
      () => console.log('Done with getDashboardData().')
    );
  }
  ngOnInit(): void {
  ...
  getVillageCount() {
    this.reportsService.getNumOfVillagesImpacted().subscribe(
      data => {
  ...
  getHours() {
    this.reportsService.getHoursLearned().subscribe(
      data => {
  ...
  getEducatedCount(): void {
    this.reportsService.getNumOfEducated().subscribe(
      data => {
        this.noOfEducatedcount = data['noOfEducatedcount'];
        this.noOfPregnantAndLactating = data['noOfPregnantAndLactating'];
        this.noOfWomenEducated = data['noOfWomenEducated'];
